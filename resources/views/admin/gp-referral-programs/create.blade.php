...
@section('title', 'Add GP Referral Program')

@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Add GP Referral Program</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Create New GP Referral Program</h3>
                    </div>
                    <!-- /.card-header -->
                    <form action="{{ route('admin.gp-referral-programs.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            @if ($errors->any())
