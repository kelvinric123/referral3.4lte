...
@section('content_header')
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a href="{{ route('admin.clinics.edit', $clinic) }}" class="btn btn-warning mr-2">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="info-box">
                        <span class="info-box-icon bg-info"><i class="fas fa-location-arrow"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">Postal Code</span>
                            <span class="info-box-number">{{ $clinic->postal_code }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer">
            <form action="{{ route('admin.clinics.destroy', $clinic) }}" method="POST" 
                ...
                <button type="submit" class="btn btn-danger">
                    <i class="fas fa-trash mr-1"></i> Delete Clinic
                </button>
            </form>
        </div>
    </div>
