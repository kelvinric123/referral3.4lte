...
@section('title', 'GP Loyalty Points History')

@section('content_header')
    <h1>GP Loyalty Points History</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">GP Information</h3>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
    ...
    <div class="card mt-4">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('admin.gp-loyalty-points.index') }}" class="btn btn-sm btn-default">
