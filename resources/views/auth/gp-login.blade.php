...
@section('title', config('app.name', 'Medical Referral System') . ' - GP Login')
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-success">
            <div class="card-header">
                <h3 class="card-title float-none text-center">GP Doctor Login</h3>
            </div>
            <div class="card-body login-card-body">
                <p class="login-box-msg">Sign in with your GP account</p>

                <form action="{{ route('gp.login') }}" method="post">
                    @csrf
