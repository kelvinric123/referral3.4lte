...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('consultant.referrals.index') }}" class="btn btn-default mr-2">
                ...
                <div class="card-body">
                    <dl>
                        ...
                        @if($referral->referrer_type === 'GP' && $referral->gp)
                            ...
                            <dt>Clinic</dt>
                            <dd>{{ $referral->gp->clinic_name ?? 'N/A' }}</dd>
                        ...
                        @elseif($referral->referrer_type === 'BookingAgent' && $referral->bookingAgent)
                            ...
                            <dt>Company</dt>
                            <dd>{{ $referral->bookingAgent->company_name ?? 'N/A' }}</dd>
...
@section('js')
    <script> console.log('Consultant referral details loaded'); </script>
@stop 