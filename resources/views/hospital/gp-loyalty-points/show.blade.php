...
@section('title', 'GP Loyalty Points Details')

@section('content_header')
    <h1>GP Loyalty Points for {{ $gp->name }}</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">GP Details</h3>
            <div class="card-tools">
                <a href="{{ route('hospital.gp-loyalty-points.index') }}" class="btn btn-sm btn-default">
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">{{ $gp->name }}</dd>
                        
                        <dt class="col-sm-4">Clinic:</dt>
                        <dd class="col-sm-8">{{ $gp->clinic->name ?? 'N/A' }}</dd>
                        
                        <dt class="col-sm-4">Email:</dt>
                        <dd class="col-sm-8">{{ $gp->email }}</dd>
                        
                        <dt class="col-sm-4">Phone:</dt>
                        <dd class="col-sm-8">{{ $gp->phone }}</dd>
                        
                        <dt class="col-sm-4">Qualifications:</dt>
                        <dd class="col-sm-8">{{ $gp->qualifications }}</dd>
                    </dl>
                </div>
                <div class="col-md-6">
